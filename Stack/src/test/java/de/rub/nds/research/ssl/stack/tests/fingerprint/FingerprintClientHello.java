...
public class FingerprintClientHello implements Observer {
     ...
     * Test constants
     */
    private final ECipherSuite[] suites1 = new ECipherSuite[]{
    ...
    public Object[][] createData1() {
        ...
        return new Object[][]{
                    ...
                    {"Protocol version SSL 3.0",
                        EProtocolVersion.SSL_3_0.getId(),
                        random2.encode(false), suites1, new byte[]{(byte) 0x00}},
                    {"Protocol version TLS 1.2",
                        EProtocolVersion.TLS_1_2.getId(),
                        random2.encode(false), suites1, new byte[]{(byte) 0x00}},
                    {"TLS_DHE_DSS and TLS_DH_DSS Cipher suites",
                        EProtocolVersion.TLS_1_0.getId(),
                    ...
                    {"No cipher suites defined",
                        EProtocolVersion.TLS_1_0.getId(),
                        random2.encode(false), suites4, new byte[]{(byte) 0x00}},
                    {"No cipher but comp-method 0x01", EProtocolVersion.TLS_1_0.
                        getId(),
    ...
    public void update(Observable o, Object arg) {
        ...
        if (states == EStates.CLIENT_HELLO) {
            ClientHello clientHello = msgBuilder.createClientHello(protVersion,
                    random, cipherSuites, compMethod);
