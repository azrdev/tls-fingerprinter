...
//        printCurves();
    ...
    public static void printCurves() {
        int P = 1; // prime curve
        ...
        add("secp192r1 [NIST P-192, X9.62 prime192v1]", "1.2.840.10045.3.1.1",
                PD,
        ...
        add("secp256r1 [NIST P-256, X9.62 prime256v1]", "1.2.840.10045.3.1.7",
                PD,
    ...
    private static void add(String name, String soid, int type, String sfield,
        ...
        System.out.println("<p></p><table>");
        System.out.println("<tr><td>Curve name</td><td>" + name + "</td></tr>");
        System.out.println("<tr><td>Curve oid</td><td>" + soid + "</td></tr>");
