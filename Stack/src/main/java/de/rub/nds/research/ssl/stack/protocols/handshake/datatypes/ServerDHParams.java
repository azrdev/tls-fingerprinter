...
/**
 * ServerDHParams part - as defined in RFC-2246. Parameters to perform
 * diffie-hellman, precisely the prime modulus, the generator and the public
 * value. Parameter length is between 1 and 2^16.
 *
 * @author Eugen Weiss - eugen.weiss@ruhr-uni-bochum.de
 * @version 0.1 Apr 17, 2012
 */
public class ServerDHParams extends APubliclySerializable implements
        IExchangeKeys {
