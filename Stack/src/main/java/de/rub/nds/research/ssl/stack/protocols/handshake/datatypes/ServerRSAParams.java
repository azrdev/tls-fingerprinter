...
/**
 * RSA Parameters as defined in RFC-2246.
 * The RSA modulus and exponent which are send in a
 * ServerKeyExchange message if "RSA_EXPORT" key
 * exchange is chosen in the cipher suite.
 * @author Eugen Weiss - eugen.weiss@ruhr-uni-bochum.de
 * @version 0.1
 * Apr 28, 2012
 */
public class ServerRSAParams extends APubliclySerializable implements IExchangeKeys {
	...
	public byte[] encode(final boolean chained) {
        ...
        System.arraycopy(length, 0, serverRSAParams, pointer, LENGTH_LENGTH_FIELD);
        pointer += LENGTH_LENGTH_FIELD;
        /*add the RSA modulus parameter*/
        System.arraycopy(this.rsaModulus, 0, serverRSAParams, pointer, this.rsaModulus.length);
        ...
        System.arraycopy(length, 0, serverRSAParams, pointer, LENGTH_LENGTH_FIELD);
        pointer += LENGTH_LENGTH_FIELD;
        System.arraycopy(this.rsaExponent, 0, serverRSAParams, pointer, this.rsaExponent.length);
