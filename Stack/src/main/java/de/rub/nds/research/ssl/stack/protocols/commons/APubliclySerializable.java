...
/**
 * Interface for all publicly serializable messages, message parts or 
 * record frames
...
public abstract class APubliclySerializable {
     ...
     * Encodes this object.
     * 
     * @param chained Encode single or chained with underlying frames 
     * as valid record layer frame
