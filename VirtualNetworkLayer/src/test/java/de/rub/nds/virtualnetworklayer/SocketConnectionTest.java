...
import de.rub.nds.virtualnetworklayer.connection.SocketConnection;
import de.rub.nds.virtualnetworklayer.connection.SocketTrace;
...
public class SocketConnectionTest {
    ...
    public void trafficCount() throws IOException {
        ...
        assertEquals(17, trace.getTrafficCountBetween(0, packet.getTimeStamp() - 1));
        assertEquals(packet.getContent().length, trace.getTrafficCountBetween(packet.getTimeStamp(), Util.now()));
    }
