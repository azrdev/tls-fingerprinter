 ...
 */
public final class CCSRecordHeader extends AGenericFingerprintTest implements
        Observer {

    private TestResult manipulateCCSRecordHeader(final String desc,
        ...
        headerParameters.setIdentifier(EFingerprintTests.CCS_RH);
