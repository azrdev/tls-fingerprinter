...
public class CommandLineWorkflowExecutor {
     ...
     * the prepared command line statement, appends Base64 encoded msg, and 
     ...
     */
    public long executeClientWithPKCS(byte[] msg) throws OracleException {
...
//                            System.out.println(ticks);
    ...
    public static void main(String[] args) throws Exception {
        ...
        clo.executeClientWithPKCS("".getBytes());
    }
}
