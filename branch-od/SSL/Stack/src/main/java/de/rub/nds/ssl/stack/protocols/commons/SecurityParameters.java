...
public final class SecurityParameters {
     ...
     */
    public synchronized void setBulkCipherAlgorithm(
            final EBulkCipherAlgorithm algorithm) {
    ...
    /**
     * Get the Key material length. The key material is computed applying the
    ...
    /**
     * Set the Key material length. The key material is computed applying the
     * PseudoRandomFunction.
     *
    ...
    /**
     * Get the master secret which is computed from the pre_master_secret
     * applying the PseudoRandomFunction.
     *
    ...
    /**
     * Set the master secret which is computed from the pre_master_secret
     * applying the PseudoRandomFunction.
     *
